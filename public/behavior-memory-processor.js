class CalcotoneBehaviorMemoryProcessor extends AudioWorkletProcessor {
  ...
  processSample(input, profile, amount, motion, memory, color, s) {
    ...
    switch (profile) {
      case 1: { // elastic / servo compliance
      ...
      case 6: { // magnetic transport / remanence
      ...
      case 7: { // acoustic diffusion / air storage
      ...
      case 8: { // granular memory / reconstruction residue
      ...
      case 9: { // mechanical transport / capstan inertia
      ...
      case 10: { // console supply / bus memory
