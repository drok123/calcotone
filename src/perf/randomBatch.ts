...
type ProfileModuleTiming = { modeMs: number; parameterMs: number; bypassMs: number; writes: number };
...
type RandomProfilerWindow = Window & {
  __calcotoneRandomProfilerStore?: { active: ActiveRandomProfile | null };
};

const MODULE_NAMES: Record<string, string> = {
  saturation: 'Ember', chorus: 'Drift', delay: 'Halo', reverb: 'Atmos', bitcrusher: 'Grain', media: 'Artifact',
};
