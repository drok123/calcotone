...
requireText(nativeHost, 'native_order[slot].store', 'Native STACK/rack atomic order');
requireText(nativeHost, 'pressure_one.process', 'Native post-STACK Pressure placement');
