...
requireText(visualEngine, 'latestVisualSpectrum = data', 'Single shared spectrum snapshot');
requireText(visualEngine, 'requestAnimationFrame(render)', 'UI animation-frame reader');
requireText(waterfall, 'getLatestVisualSpectrum()', 'Waterfall shared snapshot read');
forbidText(waterfall, 'analyser.getByteFrequencyData', 'Duplicate waterfall analyser pull');
...
console.log('CALCOTONE visual ring audit passed (lock-free ordering, wraparound, shared snapshot, analyser fallback).');
